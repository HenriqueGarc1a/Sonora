...
export const FIELDS: readonly ThemeField[] = Object.freeze([
...
export function normalize(theme: Partial<Theme> = {}): Theme {
...
export function apply(element: HTMLElement, theme: Partial<Theme> = {}): Theme {
