...
export function normalize(theme = {}) {
    return Object.fromEntries(FIELDS.map(({ key }) => [key, normalizeColor(theme[key], DEFAULT_THEME[key])]));
}
function rgb(hex) {
...
export function apply(element, theme = {}) {
